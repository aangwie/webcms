    ...
    <aside :class="[sidebarOpen?'translate-x-0':'-translate-x-full',sidebarCollapsed?'lg:w-20':'lg:w-64']" class="fixed top-0 left-0 z-50 w-64 h-full bg-slate-900 text-white transition-all duration-300 lg:translate-x-0 lg:z-30">
        ...
        <nav class="px-3 py-6 space-y-1">
            @php $nav=[
                ...
                ['route'=>'admin.sliders.index','match'=>'admin.sliders.*','label'=>'Slider','icon'=>'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z'],
                ...
                ['route'=>'admin.portfolios.index','match'=>'admin.portfolios.*','label'=>'Portofolio','icon'=>'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10'],
                ...
                ['route'=>'admin.messages.index','match'=>'admin.messages.*','label'=>'Pesan Kontak','icon'=>'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
                ...
                ['route'=>'admin.update.index','match'=>'admin.update.*','label'=>'Update Web','icon'=>'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15'],
            ]; @endphp
            @foreach($nav as $item)
